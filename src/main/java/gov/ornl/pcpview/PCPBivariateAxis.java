...
public class PCPBivariateAxis extends PCPAxis {
    ...
    public PCPBivariateAxis(PCPView pcpView, Column xColumn, Column yColumn) {
        super(pcpView, yColumn.getName() + " vs. " + xColumn.getName());
        ...
        graphicsGroup.getChildren().addAll(scatterplot.getGraphicsGroup(), scatterplotRectangle);
    }
