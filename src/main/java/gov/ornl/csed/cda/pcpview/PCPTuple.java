...
public class PCPTuple {
    ...
    public void layout(ArrayList<PCPQuantitativeAxis> axisList, PCPTemporalAxis temporalAxis) {
        if (temporalAxis != null) {
            xPoints = new double[tuple.getElementCount() + 1];
            yPoints = new double[tuple.getElementCount() + 1];
