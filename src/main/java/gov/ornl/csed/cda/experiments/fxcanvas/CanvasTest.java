package gov.ornl.csed.cda.experiments.fxcanvas;
...
public class CanvasTest extends Application {
    ...
    public void start(final Stage primaryStage) {
        ...
        final Scene scene = new Scene(rootNode, 800, 600, Color.BLACK);
        ...
        new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                for (int i=0; i<STAR_COUNT; i++) {
                    ...
                    graphicsContext.fillRect(node.getLayoutX() + node.getTranslateX(), node.getLayoutY() + node.getTranslateY(),
