 ...
 */
public class Histogram2DOLD {
    private final static Logger log = Logger.getLogger(Histogram2DOLD.class.getName());
    ...
    public Histogram2DOLD(String name, double xData[], double yData[], int numBins) {
        this.name = name;
        this.xData = xData;
        this.yData = yData;
    ...
    public Histogram2DOLD(String name, double xData[], double yData[], int numBins, double xMinValue,
...
//        Histogram2DOLD histogram = new Histogram2DOLD("Test", xData, yData, 5, 140, 190, 140, 190);
        Histogram2DOLD histogram = new Histogram2DOLD("Test", xData, yData, 3, 1, 4, 11, 14);
