 ...
 */
public class NewHistogramPanel extends JComponent implements ComponentListener, MouseListener, MouseMotionListener {
    ...
    private final static Logger log = LoggerFactory.getLogger(NewHistogramPanel.class);
...
//    private double maxOverallBinSize;
    ...
    public NewHistogramPanel(ORIENTATION orientation, STATISTICS_MODE statisticsMode) {
    ...
    public static void main (String args[]) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                NewHistogramPanel horizontalHistogramPanel = new NewHistogramPanel(ORIENTATION.HORIZONTAL, STATISTICS_MODE.MEAN_BASED);
...
//                horizontalHistogramPanel.setBorder(BorderFactory.createTitledBorder("Horizontal Histogram"));
                ...
                NewHistogramPanel verticalHistogramPanel = new NewHistogramPanel(ORIENTATION.VERTICAL, STATISTICS_MODE.MEAN_BASED);
