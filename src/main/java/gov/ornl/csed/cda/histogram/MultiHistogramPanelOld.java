 ...
 */
public class MultiHistogramPanelOld extends JComponent implements ComponentListener {
    private final static Logger log = LoggerFactory.getLogger(MultiHistogramPanelOld.class);
    ...
    public static void main (String args[]) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                MultiHistogramPanelOld multiHistogramPanel = new MultiHistogramPanelOld();
                multiHistogramPanel.setBackground(Color.white);
                multiHistogramPanel.setBorder(BorderFactory.createTitledBorder("MultiHistogramPanelOld"));
