 ...
 * used when a datamodel value is encountered in parsing.
 * 
...
public interface TableReadListener {
    ...
    /**
     * Notification that a text string representing a datamodel value has
     ...
     * @param col the datamodel column index at which the value was encountered
