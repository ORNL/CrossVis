...
public class TableTuple implements Tuple {
    ...
    /**
     * Initialize a new TableTuple for the given datamodel and row. Tuples are
    ...
    /**
     * Invalidates this tuple. Called by an enclosing datamodel when a row
     * is deleted.
     */
    void invalidate() {
        m_row = -1;
    ...
    private void validityCheck() {
        if ( m_row == -1 ) {
            throw new IllegalStateException("This tuple is no longer valid. " +
                "It has been deleted from its datamodel");
        }
    }
